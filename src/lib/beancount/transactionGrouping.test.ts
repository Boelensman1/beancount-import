...
describe('transactionGrouping', () => {
  ...
  it('should group transactions by outputFile from internalMetadata', () => {
        ...
        transactions: [
          {
            id: 'tx-1',
            originalTransaction: '',
            processedNodes: JSON.stringify([tx1.toJSON()]),
            matchedRules: [],
            warnings: [],
            skippedRuleIds: [],
          },
          {
            id: 'tx-2',
            originalTransaction: '',
            processedNodes: JSON.stringify([tx2.toJSON()]),
            matchedRules: [],
            warnings: [],
            skippedRuleIds: [],
          },
          {
            id: 'tx-3',
            originalTransaction: '',
            processedNodes: JSON.stringify([tx3.toJSON()]),
            matchedRules: [],
            warnings: [],
            skippedRuleIds: [],
          },
    ...
    expect(group1!.nodes).toHaveLength(2)
    ...
    expect(group2!.nodes).toHaveLength(1)
  ...
  it('should handle single account with multiple output files from rules', () => {
    ...
    expect(businessGroup?.nodes).toHaveLength(1)
      ...
      },
      {
        ...
        transactions: [
          ...
          },
          {
            id: 'tx-4',
            originalTransaction: '',
            processedNodes: JSON.stringify([tx4.toJSON()]),
            matchedRules: [],
            warnings: [],
            skippedRuleIds: [],
          },
